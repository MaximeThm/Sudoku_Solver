...
def random_board():
    ...
    squares = 9 * 9
    # if 1 // 4 easy ; 2 // 4 medium ; 3 // 4 hard
    empties = squares * 70 // 100
...
def instruction():
    text1 = font2.render("PRESS D TO RESET TO RANDOM GRID / R TO EMPTY", 1, (0, 0, 0))
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_r:
                ...
                # If D is pressed reset the board to random grid
